...
public class EstructuraBBDD {
    ...
    public static final String crearEntrenamientos =
            "CREATE TABLE IF NOT EXISTS " + EstructuraEntrenamientos.TABLE_NAME_ENTRENAMIENTOS + "(" +
                    ...
                    EstructuraEntrenamientos.COLUMN_NAME_EJER + " text, " +
                    "FOREIGN KEY(" + EstructuraEntrenamientos.COLUMN_NAME_EJER + ") REFERENCES " +
                    EstructuraEjercicios.TABLE_NAME_EJERCICIOS + " (" + EstructuraEjercicios.COLUMN_NAME_NOMBREEJER + "));";
